...
#include "../FootballLeagueDataSystem/schedulewindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_scheduleWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_scheduleWindow_t qt_meta_stringdata_scheduleWindow = {
    {
QT_MOC_LITERAL(0, 0, 14), // "scheduleWindow"
QT_MOC_LITERAL(1, 15, 18), // "scheduleWindowBack"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 28) // "teamDataWindowShowAndGetTeam"

    },
    "scheduleWindow\0scheduleWindowBack\0\0"
    "teamDataWindowShowAndGetTeam"
};
...
void scheduleWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->scheduleWindowBack(); break;
        ...
        {
            typedef void (scheduleWindow::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&scheduleWindow::scheduleWindowBack)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (scheduleWindow::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&scheduleWindow::teamDataWindowShowAndGetTeam)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject scheduleWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_scheduleWindow.data,
      qt_meta_data_scheduleWindow,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void scheduleWindow::scheduleWindowBack()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void scheduleWindow::teamDataWindowShowAndGetTeam()
{
